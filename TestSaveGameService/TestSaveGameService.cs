    ...
    public class TestSaveGameService
    {
        ...
        public void Test_Restore_0_1_000()
        {
            GameSession gameSession =
                SaveGameService
                    .LoadLastSaveOrCreateNew(@".\TestFiles\SavedGames\Game_0_1_000.nabisfrstrpg");
            ...
            // Player data
            Assert.AreEqual("Warrior", gameSession.CurrentPlayer.CharacterClass);
            Assert.AreEqual("Jaydris", gameSession.CurrentPlayer.Name);
            ...
            Assert.AreEqual(10, gameSession.CurrentPlayer.Gold);
